...
console.log("== initial (sqe-8d enabled) ==")
console.log("persona section present:", p1 !== undefined)
if (p1) {
  console.log("text:", JSON.stringify(p1.text))
}
...
console.log("persona section present:", p3 !== undefined)
if (p3) {
  console.log("has sqe:", p3.text.includes("sqe-8d"))
  console.log("has hr:", p3.text.includes("hr-management"))
  console.log("has tag [text]:", p3.text.includes("[text]"))
}
